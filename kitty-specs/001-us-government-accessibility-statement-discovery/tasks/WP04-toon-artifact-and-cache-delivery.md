...
- Steps:
  ...
  2. Path convention should be jurisdiction then run month.
...
- Steps:
  ...
  2. Resolve latest completed monthly snapshot per jurisdiction.
  3. Handle missing-jurisdiction artifacts with explicit not-found result.
- Files:
...
- Steps:
  ...
  2. Accept jurisdiction code and run month arguments.
