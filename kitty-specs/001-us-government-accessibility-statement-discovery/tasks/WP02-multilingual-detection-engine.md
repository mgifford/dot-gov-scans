...
- Build glossary-driven statement detection across configured glossary languages.
- Emit statement status, URL, confidence tier, language tag, and evidence terms.
- Success criteria:
  - Glossary contains complete configured glossary language coverage.
...
### Subtask T007 - Implement project glossary store
...
- Steps:
  ...
  3. Validate presence of all configured glossary language codes.
