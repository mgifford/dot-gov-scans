...
- Must preserve US-first monthly scan semantics.
...
- Steps:
  ...
  2. Measure monthly jurisdiction run timing and throughput with representative fixture sizes.
...
- Files:
  - `README.md`
  - `/workspaces/dot-gov-scans/kitty-specs/001-us-government-accessibility-statement-discovery/quickstart.md`
- Parallel: No.
