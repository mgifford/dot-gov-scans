...
- Spec path: `/workspaces/dot-gov-scans/kitty-specs/001-us-government-accessibility-statement-discovery/spec.md`
- Plan path: `/workspaces/dot-gov-scans/kitty-specs/001-us-government-accessibility-statement-discovery/plan.md`
- Data model path: `/workspaces/dot-gov-scans/kitty-specs/001-us-government-accessibility-statement-discovery/data-model.md`
- Use Python 3.12 with FastAPI stack defined in plan.
- Canonical uniqueness key must be full hostname per jurisdiction.
...
- Steps:
  ...
  3. Capture `jurisdiction_code`, `input_hostname`, `source_type`, `source_reference_url`.
...
- Steps:
  ...
  3. Include correlation fields (`scan_id`, `jurisdiction_code`, `hostname` where applicable).
- Files:
  - `src/lib/logging.py`
  - `src/lib/errors.py`
